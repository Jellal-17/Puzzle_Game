...
class Solution(Game):
    ...
    def astar_plan(self):
        ...
        cost_so_far = {start_state: 0}     # g-score
    ...
    def heuristic(self, state):
        ...
        for i, has_col in enumerate(colors):
            ...
            # let's pick a fixed cell for color, e.g. (2,1) from the default world...
    ...
    def find_color_tile(self):
        ...
        We'll just return that for clarity.
        """
    ...
    def is_door_open(self):
        ...
        """
        # By default, self.door is (3, 2), if world[y=2][x=3] == 0, door is open, if == 1, door is closed
        
        return (self.world[self.door[1]][self.door[0]] == 0)
    
    def world_with_door(self, door_open):
        """
        Return a copy of the world grid that shows the correct state of the door
        """
...
if __name__ == "__main__":
    mygame = Solution(algorithm='A-star') # 'BFS', 'DFS', 'A-star'
    mygame.main()
